...
import { listAdminClosedComplaintsApi, reopenComplaintApi } from '../services/complaintService.js'
...
export default function AdminClosedComplaints() {
  ...
  const load = async () => {
    ...
    setLoading(true)
    try {
      const data = await listAdminClosedComplaintsApi()
